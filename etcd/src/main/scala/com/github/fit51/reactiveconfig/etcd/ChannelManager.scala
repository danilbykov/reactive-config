...
import com.github.fit51.reactiveconfig.etcd.auth.gen.rpc.{AuthGrpc, AuthenticateRequest, AuthenticateResponse}
...
object ChannelManager {
  ...
  def apply(
    ...
    val uris = endpoints
      ...
      .mkString(",")
    val target = s"https://${authority.getOrElse("etcd")}/$uris"
